package com.zaneschepke.wireguardautotunnel.core.terminal.view;
...
import com.zaneschepke.wireguardautotunnel.core.terminal.backend.*;
import com.zaneschepke.wireguardautotunnel.core.terminal.view.GestureAndScaleRecognizer;
...
public final class TerminalView extends View {
    ...
    if (mIsSelectingText) {
      ...
      final ActionMode.Callback callback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
          ...
          menu.add(Menu.NONE, 3, Menu.NONE, android.R.string.selectAll);
  ...
  public Object getOnAutoCompleteListener() {
    return null;
  }

  public void setOnAutoCompleteListener(Object x) {
    ;
  }
